...
import com.akgarg.subsservice.v1.plans.plan.db.PlanDatabaseService;
import com.akgarg.subsservice.v1.subs.db.SubscriptionDatabaseService;
import com.akgarg.subsservice.v1.subs.db.SubscriptionRepository;
...
public class SubscriptionService {
    ...
    private final PlanDatabaseService planDatabaseService;
    ...
    public MakeSubscriptionResponse subscribe(final MakeSubscriptionRequest request) {
        ...
        final Plan plan = planDatabaseService.findById(request.planId())
                .orElseThrow(() -> {
        ...
        final Optional<Subscription> lastSubscription = subscriptionDatabaseService.findFirstByUserIdOrderByExpiresAtDesc(request.userId());
        ...
        final Subscription createdSubscription = subscriptionDatabaseService.saveOrUpdate(subscription);
    ...
    public GetSubscriptionResponse getSubscriptionByUserId(final String userId) {
        ...
        final Optional<Subscription> subscriptionOptional = subscriptionDatabaseService.findFirstByUserIdOrderByExpiresAtDesc(userId);
    ...
    public VerifySubscriptionResponse verifySubscription(final VerifySubscriptionRequest request) {
        ...
        final Optional<Subscription> subscriptionOptional = subscriptionDatabaseService.findFirstByUserIdOrderByExpiresAtDesc(request.userId());
